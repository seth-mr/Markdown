...
*DEFECTO* ->
	La causa de una [[FALLA]]. Puede ser un defecto en el codigo,  , o en el proceso.
...
*PRIORIZACION* -> 
- Determinar la importancia relativa de cada atributo para guiar el 
*VALIDACION* -> 
...
Las decisiones durante el DiseñodeSoftwarearquitectonico **determinan** en gran parte si el sistema  **cumplira** o no con los requisitos de **calidad.**
...
*Restricciones :* -> 
- Es una decision de DiseñodeSoftware con cero grados de libertad. Es decir, una que ya ah sido tomada
...
- Es improbable que se obtenga un Diseñoperfecto en el primer intento.
...
- Promueven la *Separacion de responsabilidades* para facilitar la interacción del Diseño
